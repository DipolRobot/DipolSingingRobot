...
/* 8 diod LED prz≥Ļczonych do portu D */
/* ATmega 1MHz */
...
3. Chwycenie d≥oni po podaniu impulsu zewnÍtrznego 1
4. Obrůt d≥oni po podaniu impulsu zewnÍtrznego 2
5. Ponowna kalibracja po okreúlonym czasie
...
#define K5 0x02  // Krok piĻty, Uzwojenie 2 ok
#define K6 0x06  // Krok szůsty, Uzwojenie 2, 1 ok
#define K7 0x04  // Krok siůdmy, Uzwojenie 1
#define K8 0x24  // Krok ůsmy, Uzwojenie 1,4
...
#define KD5 0x10  // Krok piĻty, Uzwojenie 2
#define KD6 0x18  // Krok szůsty, Uzwojenie 2, 1
#define KD7 0x08  // Krok siůdmy, Uzwojenie 1
#define KD8 0x48  // Krok ůsmy, Uzwojenie 1,4

#define KD11 0x68  // Krok ůsmy, Uzwojenie 4
#define KD12 0x29  // Krok ůsmy, Uzwojenie 4,3
#define KD13 0x19  // Krok ůsmy, Uzwojenie 3
#define KD14 0x13  // Krok ůsmy, Uzwojenie 3,2  
#define KD15 0x92  // Krok ůsmy, Uzwojenie 2
#define KD16 0x86  // Krok ůsmy, Uzwojenie 2,1
#define KD17 0xC4  // Krok ůsmy, Uzwojenie 1
#define KD18 0x64  // Krok ůsmy, Uzwojenie 1,4


//s1 PRAWO LEWO
//s2 OBROT PRAWO

#define KR_S1 224 //PoloŅenie kraŮcowe silnik pierwszy (obroty prawo, lewo) 224
#define KR_S2 916 //PoloŅenie kraŮcowe silnik drugi (rÍka) 916
#define KR_K_S1 190 //PoloŅenie kraŮcowe silnik pierwszy - druga strona (obroty prawo, lewo) 214
#define KR_K_S2 800 //PoloŅenie kraŮcowe silnik drugi - druga strona (rÍka) 902

#define K_S1_Pelny 160 // Pe≥ny obrůt na ile pozwala ograniczenie mechaniczne - obroty prawo,lewo 204
#define K_S2_Pelny 700 // Pe≥ny obrůt na ile pozwala ograniczenie mechaniczne - rÍka 870

#define K_S1_Plowa 80 // Polowa  - obroty prawo,lewo 102
#define K_S2_Polowa 350 // Pe≥ny obrůt na ile pozwala ograniczenie mechaniczne - rÍka 436


//Tablica sterowania dla silnika pierwszego pod≥aczonego do portu C

int tster_polkr_prawo_lewo[8] = {K8, K7, K6, K5, K4, K3, K2, K1}; // Metoda pů≥krokowa
int tster_polkr_gora_dol[8] = {KD1, KD2, KD3, KD4, KD5, KD6, KD7, KD8}; // Metoda pů≥krokowa
...
//int krok=0; //ZapamiÍtanie katualnej wartoúci kroku - indeks kroku od 0 - 7
...
ISR(INT0_vect)
{
  ...
  _delay_ms(1500); // odczekaj 3 skundy
...
{
  DDRB=0xff;
    DDRC = 0xff; //Ustawienie lini PC0-PC7 jako wyjúcia (pierwszy silnik)
  
  
    
    //Globalna obs≥uga przerwaŮ
    ...
    cala_reka__wylacz(); //Resetowanie palcůw
